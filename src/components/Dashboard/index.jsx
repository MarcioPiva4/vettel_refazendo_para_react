...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      <DashboardTop
        titleBold="O que você gostaria de fazer?"
        subtitle={`Olá ${nameUser}`}
      />
