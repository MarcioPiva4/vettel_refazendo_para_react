...
export default function Header({ bg, isDashboard, isNotFound}) {
  ...
  return (
    <>
      {isDashboard ? (
        <header
          className={themeDark ? styles.header__darkMode : styles.header}
          style={
        ...
        >
          ...
          <div
            ...
            style={themeDark ? {backgroundColor:'#282D35'} : {backgroundColor: '#fff'}}
          >
            <ul className={styles.ul__dashboard}>
              <li onClick={closeMenu}>
                <Link to="/painel" style={themeDark ? {color:'#fff'} : {color:"#E40101"}}>
                  <svg
                    width="33"
                    height="33"
                    viewBox="0 0 37 36"
              ...
              <li onClick={closeMenu}>
                <Link to="/painel/planos" style={themeDark ? {color:'#fff'} : {color:"#E40101"}}>
                  <svg
                    width="33"
                    height="33"
                    viewBox="0 0 37 40"
              ...
              <li onClick={closeMenu}>
                <Link to="/painel/contato" style={themeDark ? {color:'#fff'} : {color:"#E40101"}}>
                  <svg
                    width="33"
                    height="33"
                    viewBox="0 0 33 40"
              ...
              <li onClick={closeMenu}>
                <Link to="/painel/perfil" style={themeDark ? {color:'#fff'} : {color:"#E40101"}}>
                  <svg
                    width="33"
                    height="33"
                    viewBox="0 0 41 40"
