          ...
          >
            <ul className={styles.ul__dashboard}>
              <li onClick={closeMenu}>
                <Link to='/dashboard'>
                  <svg width="33" height="33" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 13.5V0H36.5V13.5H20ZM0.5 19.5V0H17V19.5H0.5ZM20 36V16.5H36.5V36H20ZM0.5 36V22.5H17V36H0.5ZM3.5 16.5H14V3H3.5V16.5ZM23 33H33.5V19.5H23V33ZM23 10.5H33.5V3H23V10.5ZM3.5 33H14V25.5H3.5V33Z" fill="#E40101"/></svg>
                  Dashboard
                </Link>
              </li>
              ...
              <li onClick={closeMenu}>
                <Link to='/dashboard/planos'>
                  <svg width="33" height="33" viewBox="0 0 37 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.5 40C2.675 40 1.96875 39.7062 1.38125 39.1188C0.79375 38.5312 0.5 37.825 0.5 37V7C0.5 6.175 0.79375 5.46875 1.38125 4.88125C1.96875 4.29375 2.675 4 3.5 4H13.75C13.9167 2.83333 14.45 1.875 15.35 1.125C16.25 0.375 17.3 0 18.5 0C19.7 0 20.75 0.375 21.65 1.125C22.55 1.875 23.0833 2.83333 23.25 4H33.5C34.325 4 35.0312 4.29375 35.6188 4.88125C36.2062 5.46875 36.5 6.175 36.5 7V37C36.5 37.825 36.2062 38.5312 35.6188 39.1188C35.0312 39.7062 34.325 40 33.5 40H3.5ZM3.5 37H33.5V7H3.5V37ZM8.5 32H22.15V29H8.5V32ZM8.5 23.5H28.5V20.5H8.5V23.5ZM8.5 15H28.5V12H8.5V15ZM18.5 6.15C18.9667 6.15 19.375 5.975 19.725 5.625C20.075 5.275 20.25 4.86667 20.25 4.4C20.25 3.93333 20.075 3.525 19.725 3.175C19.375 2.825 18.9667 2.65 18.5 2.65C18.0333 2.65 17.625 2.825 17.275 3.175C16.925 3.525 16.75 3.93333 16.75 4.4C16.75 4.86667 16.925 5.275 17.275 5.625C17.625 5.975 18.0333 6.15 18.5 6.15Z" fill="#E40101"/></svg>
                  Meus planos
                </Link>
              </li>
