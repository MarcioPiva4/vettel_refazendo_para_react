...
export default function ConnectedDevices({ isDashboardHome }){
    ...
    return(
        isDashboardHome 
        ? 
        <div className={styles.device__container__dashboardhome} style={themeDark ? {backgroundColor:"#0E0F11", color:"#fff"} : {}}>
        ...
        <>
            ...
            <main>
                <div className={styles.device__container__connecteddevices}>
                    <div className={styles.device__container__connecteddevices__content} style={themeDark ? {backgroundColor:"#0E0F11", color:"#fff"} : {}}>
                        {iconDevice()}
                    </div>

                    <Link to={'/painel/dispositivos-conectados/qr-code'}>
                        <div className={styles.device__container__connecteddevices__more} style={themeDark ? {backgroundColor:"#0E0F11", color:"#fff"} : {}}>
